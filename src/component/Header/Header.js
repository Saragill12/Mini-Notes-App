    ...
    >
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          {/* ---- Left side (Mini Notes logo + title) ---- */}
          ...
          {/* ---- Right side (SearchBar, ThemeToggle, New Note button) ---- */}
          <div
            className="
              flex flex-col sm:flex-row items-center gap-3 
              sm:gap-4 
              sm:ml-[-6rem] md:ml-[-8rem] lg:ml-[-10rem]
          ...
          >
            ...
            <button
              onClick={onNewNote}
              className={`w-full sm:w-auto px-4 py-2 rounded-lg font-semibold transition-all flex items-center justify-center gap-2 ${
                isDarkMode
